...
def order_pizza():
  ...
  pizza_order["customer_name"] = input("Please enter your name: ")
  pizza_order["size"] = input("What size pizza would you like? (small, medium, large) ")
  ...
  while len(pizza_order["toppings"]) < pizza_order["num_toppings"]:
    current_topping = input("Enter a topping: ")
